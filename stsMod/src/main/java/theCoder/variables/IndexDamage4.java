...
public class IndexDamage4 extends DynamicVariable {

    //For in-depth comments, check the other variable(DefaultCustomVariable). It's nearly identical.

    @Override
    public String key() {
        return makeID("IndexDamage4");
    ...
    public int value(AbstractCard card) {
        return ((AbstractDefaultCard) card).indexDamage4;
    }

    @Override
    public int baseValue(AbstractCard card) {
        return ((AbstractDefaultCard) card).baseIndexDamage4;
    }
