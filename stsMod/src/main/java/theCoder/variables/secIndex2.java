...
public class secIndex2 extends DynamicVariable {

    //For in-depth comments, check the other variable(DefaultCustomVariable). It's nearly identical.

    @Override
    public String key() {
        return makeID("SecIndex2");
    ...
    public int value(AbstractCard card) {
        return ((AbstractCoderCard) card).secIndex2;
    }

    @Override
    public int baseValue(AbstractCard card) {
        return ((AbstractCoderCard) card).secBaseIndex2;
    }
