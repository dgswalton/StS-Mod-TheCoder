...
public class secIndex4 extends DynamicVariable {

    //For in-depth comments, check the other variable(DefaultCustomVariable). It's nearly identical.

    @Override
    public String key() {
        return makeID("SecIndex4");
    ...
    public int value(AbstractCard card) {
        return ((AbstractCoderCard) card).secIndex4;
    }

    @Override
    public int baseValue(AbstractCard card) {
        return ((AbstractCoderCard) card).secBaseIndex4;
    }
