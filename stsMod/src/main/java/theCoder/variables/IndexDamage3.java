...
public class IndexDamage3 extends DynamicVariable {

    //For in-depth comments, check the other variable(DefaultCustomVariable). It's nearly identical.

    @Override
    public String key() {
        return makeID("IndexDamage3");
    ...
    public int value(AbstractCard card) {
        return ((AbstractDefaultCard) card).indexDamage3;
    }

    @Override
    public int baseValue(AbstractCard card) {
        return ((AbstractDefaultCard) card).baseIndexDamage3;
    }
