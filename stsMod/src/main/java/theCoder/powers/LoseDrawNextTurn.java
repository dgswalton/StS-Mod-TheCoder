...
public class LoseDrawNextTurn extends AbstractPower {
    public AbstractCreature source;
    public static final String POWER_ID = TheCoderMod.makeID("LoseDrawNextTurn");
    ...
    private static boolean justApplied = true;
    private static int handSize = AbstractDungeon.player.gameHandSize;
    public LoseDrawNextTurn(final AbstractCreature owner, final int amount) {
        this.name = NAME;
        this.amount = amount;
        this.ID = "LoseDrawNextTurn";
        this.owner = owner;
    ...
    public void onInitialApplication() {
        AbstractDungeon.player.gameHandSize = handSize - this.amount;
    }
