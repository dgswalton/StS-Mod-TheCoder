...
import static theCoder.TheCoderMod.makePowerPath;

public class ForLoopPower extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = TheCoderMod.makeID("ForLoopPower");
