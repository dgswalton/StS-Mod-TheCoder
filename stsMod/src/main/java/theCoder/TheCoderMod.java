...
import theCoder.relics.DefaultClickableRelic;
import theCoder.relics.PlaceholderRelic;
...
@SpireInitializer
public class TheCoderMod implements
        EditCardsSubscriber,
    ...
    public static Properties theCoderDefaultSettings = new Properties();
    ...
    private static final String ATTACK_DEFAULT_GRAY = "theCoderResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "theCoderResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "theCoderResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "theCoderResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "theCoderResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "theCoderResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "theCoderResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "theCoderResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "theCoderResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "theCoderResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "theCoderResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "theCoderResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "theCoderResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "theCoderResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "theCoderResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "theCoderResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "theCoderResources/images/char/defaultCharacter/skeleton.json";
    ...
    public TheCoderMod() {
      ...
      */
        ...
        theCoderDefaultSettings.setProperty(ENABLE_PLACEHOLDER_SETTINGS, "FALSE"); // This is the default setting. It's actually set...
        try {
            SpireConfig config = new SpireConfig("defaultMod", "theCoderConfig", theCoderDefaultSettings); // ...right here
    ...
    public static void setModID(String ID) { // DON'T EDIT
        ...
        InputStream in = TheCoderMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THIS ETHER
    ...
    private static void pathCheck() { // ALSO NO
        ...
        InputStream in = TheCoderMod.class.getResourceAsStream("/IDCheckStringsDONT-EDIT-AT-ALL.json"); // DON'T EDIT THISSSSS
        IDCheckDontTouchPls EXCEPTION_STRINGS = coolG.fromJson(new InputStreamReader(in, StandardCharsets.UTF_8), IDCheckDontTouchPls.class); // NAH, NO EDIT
        String packageName = TheCoderMod.class.getPackage().getName(); // STILL NO EDIT ZONE
    ...
    public static void initialize() {
        ...
        TheCoderMod defaultmod = new TheCoderMod();
    ...
    public void receivePostInitialize() {
        ...
        ModLabeledToggleButton enableNormalsButton = new ModLabeledToggleButton("This is the text which goes next to the checkbox.",
            ...
            try {
                ...
                SpireConfig config = new SpireConfig("defaultMod", "theCoderConfig", theCoderDefaultSettings);
