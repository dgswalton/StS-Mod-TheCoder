...
import theCoder.patches.relics.BottledPlaceholderField;
import theCoder.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static theCoder.TheCoderMod.makeRelicOutlinePath;
import static theCoder.TheCoderMod.makeRelicPath;
...
public class BottledPlaceholderRelic extends CustomRelic implements CustomBottleRelic, CustomSavable<Integer> {
    ...
    // ID, images, text.
    public static final String ID = TheCoderMod.makeID("BottledPlaceholderRelic");
