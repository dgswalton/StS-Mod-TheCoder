...
public class CardMissingComments extends AbstractCoderCard {
    ...
    public static final String ID = TheCoderMod.makeID(CardMissingComments.class.getSimpleName());
