...
public class CardSort extends AbstractCoderCard {
    ...
    public static final String ID = TheCoderMod.makeID(CardSort.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new ScryAction(p.drawPile.size()));
    }
