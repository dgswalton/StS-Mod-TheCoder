...
import theCoder.actions.ForLoopAction;
...
public class CardForLoop extends AbstractCoderCard {
    ...
    public static final String ID = TheCoderMod.makeID(CardForLoop.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    // path to picture
    public static final String IMG = makeCardPath("ForLoop.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ForLoopAction(p, this.freeToPlayOnce, this.energyOnUse, this.upgraded));
    }
