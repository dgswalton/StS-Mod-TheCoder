...
public class CardStackOverflow extends AbstractCoderCard {
    ...
    public static final String ID = TheCoderMod.makeID(CardStackOverflow.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    // path to picture
    public static final String IMG = makeCardPath("StackOverflow.png");
    ...
    private static final int UPGRADE_PLUS_BLOCK_AND_DAMAGE = 3;
    private static final int UPGRADE_PLUS_DRAE = 1;

    // /STAT DECLARATION/

    public CardStackOverflow() {
    ...
    public void upgrade() {
        if (!upgraded) {
            this.upgradeName();
            this.upgradeBlock(UPGRADE_PLUS_BLOCK_AND_DAMAGE);
            this.upgradeDamage(UPGRADE_PLUS_BLOCK_AND_DAMAGE);
            this.upgradeMagicNumber(UPGRADE_PLUS_DRAE);
