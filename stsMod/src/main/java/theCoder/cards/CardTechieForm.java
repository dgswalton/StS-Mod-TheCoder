...
import theCoder.powers.TechieFormPower;
...
public class CardTechieForm extends AbstractCoderCard {
    ...
    public static final String ID = TheCoderMod.makeID(CardTechieForm.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    // path to picture
    public static final String IMG = makeCardPath("TechiForm.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        this.addToBot(new ApplyPowerAction(p, p, new TechieFormPower(p)));
    }
