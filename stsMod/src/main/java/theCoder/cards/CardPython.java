...
public class CardPython extends AbstractCoderCard {
    ...
    public static final String ID = TheCoderMod.makeID(CardPython.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    // path to picture
    public static final String IMG = makeCardPath("Python.png");
