...
public class CardLinkedList extends AbstractCoderCard {
    ...
    public static final String ID = TheCoderMod.makeID(CardLinkedList.class.getSimpleName());
    private static final CardStrings cardStrings = CardCrawlGame.languagePack.getCardStrings(ID);
    // path to picture
    public static final String IMG = makeCardPath("LinkedList.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractDungeon.actionManager.addToBottom(
                new ApplyPowerAction(p, p, new LinkedListPower(p, this.upgraded)));
    }
